...
## 个人感受
在做的时候其实遇到了挺多问题的，最开始没有用镜像网站侥幸卡着出了第一版的2048，自己实验了一下发现问题很大，包括但不限于逻辑问题，作为国内AI，豆包真的提升空间有点大。然后我试图用豆包ds千问改对，但是他们都不约而同发挥了自己的特性：撒谎。并且过程中多次修改我的指令，最后我强制询问回归问题，才告诉我我的FTXUI与Mingw版本并不匹配，明王是我之前自己安装的，比较老了，没办法只能重新下，结果无法删掉最开始的老版本，于是成功地看着报错一个又一个，原因是我混用，依旧不适配，最后自己又问了问，不删除，重新建文件夹，改Path，才终于算配置好自己的环境，结果豆包的代码错误实在是太多，除了被它耍了一遍又一遍，我甚至连自己debug的功能都不具备，只能听它的改了这个改那个，改来改去都不对。最后实在红温就去用了点魔法换了个语言模型，月亮真圆啊。。不过这一番操作下来，给我的感触最深的还是提升自我能力，没有自己判别能力的码农除了被AI戏耍还有什么路子呢。国内AI只能做个引路的吧，实操只能自己加国外LLM，仅为个人感想，说到底依旧是自身能力不足罢了，道阻且长呐。。。
